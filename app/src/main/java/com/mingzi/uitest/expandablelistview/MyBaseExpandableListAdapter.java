...
public class MyBaseExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        groupHolder.tv_group_name.setText(gData.get(groupPosition).getmGroup());
        return convertView;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        itemHolder.img_icon.setImageResource(iData.get(groupPosition).get(childPosition).getmImgId());
        itemHolder.tv_name.setText(iData.get(groupPosition).get(childPosition).getmPlayerName());
        return convertView;
    }
